...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null)
        {
            ...
            } else if(status.equalsIgnoreCase("purchase_subscription")){
                navController.navigateUp();
                String type = intent.getString("type");
                if(type.equalsIgnoreCase("subscriber"))
                {
                    Bundle bundle = new Bundle();
                    navController.navigate(R.id.myPurchasedSubscriptionFragment,bundle);
                }
                else
                {
                    Bundle bundle = new Bundle();
                    navController.navigate(R.id.myFanSubscriberFragment,bundle);
                }
            }else if(status.equalsIgnoreCase("subscription_expires")){
                navController.navigateUp();
                String id = intent.getString("id");
                Bundle bundle = new Bundle();
                bundle.putString("otherUser",id);
                navController.navigate(R.id.otherUserDetailFragment,bundle);
            }
        }
