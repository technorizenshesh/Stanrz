 ...
 */
public class MyFanAdapter extends RecyclerView.Adapter<MyFanAdapter.ChatViewHolder> {
 ...
 public MyFanAdapter(Context context, List<SuccessResGetMyPurchasedPlan.Result> planList)
 {
