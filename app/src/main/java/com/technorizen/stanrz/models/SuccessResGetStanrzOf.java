...
public class SuccessResGetStanrzOf implements Serializable {
    ...
    public class Result {
        ...
        @SerializedName("top_superlike")
        @Expose
        public String topSuperlike;
        ...
        public String getTopSuperlike() {
            return topSuperlike;
        }

        public void setTopSuperlike(String topSuperlike) {
            this.topSuperlike = topSuperlike;
        }
